class ActiveRecord::Base
  module DeepCloneable
    ...
    def deep_clone *args, &block
      ...
      kopy = unless dict
        ...
        self.find_in_dict_or_clone(dict)
      end
  ...
  protected
    ...
    def find_in_dict_or_clone(dict, clone_on_miss = true)
      ...
      (dict_val.nil? and clone_on_miss) ? dict[tableized_class][self] = self.dup() : dict_val
    end
  ...
  private
    ...
    def dup_join_association options, &block
      ...
      objects.collect do |object|
        ...
        if(dict and object.find_in_dict_or_clone(dict, false))
          object = object.deep_clone(options[:dup_options], &block)
        else
